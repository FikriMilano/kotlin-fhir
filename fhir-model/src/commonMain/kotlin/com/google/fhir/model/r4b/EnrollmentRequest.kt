...
import com.google.fhir.model.r4b.serializers.EnrollmentRequestSerializer
...
public data class EnrollmentRequest(
  ...
  public class Builder() : DomainResource.Builder() {
    ...
    /** Patient Resource. */
    public var candidate: Reference.Builder? = null

    /** Reference to the program or plan identification, underwriter or payor. */
    public var coverage: Reference.Builder? = null

    override fun build(): EnrollmentRequest =
      EnrollmentRequest(
        id = id,
        meta = meta?.build(),
