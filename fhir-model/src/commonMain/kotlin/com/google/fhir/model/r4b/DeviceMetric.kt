...
import com.google.fhir.model.r4b.serializers.DeviceMetricCalibrationSerializer
...
public data class DeviceMetric(
   ...
   * example would be a Device that represents a Channel. This reference can be used by a client
   ...
   * a measurement repetition time in the range of milliseconds is the sampling rate of an ECG. An
   * example for a measurement repetition time in the range of hours is a NIBP that is triggered
   * automatically every hour. The update period may be different than the measurement repetition
  ...
  public class Builder(
     ...
     * of the identifier should be set to the unique identifier of the device.
     */
     ...
     * parent Device. An example would be a Device that represents a Channel. This reference can be
     * used by a client application to distinguish DeviceMetrics that have the same type, but should
     ...
     * Describes the color representation for the metric. This is often used to aid clinicians to
     * track and identify parameter types by color. In practice, consider a Patient Monitor that has
     * ECG/HR and Pleth for example; the parameters are displayed in different characteristic
    ...
    /**
     * Describes the measurement repetition time. This is not necessarily the same as the update
     * period. The measurement repetition time can range from milliseconds up to hours. An example
     * for a measurement repetition time in the range of milliseconds is the sampling rate of an
     * ECG. An example for a measurement repetition time in the range of hours is a NIBP that is
     * triggered automatically every hour. The update period may be different than the measurement
     * repetition time, if the device does not update the published observed value with the same
     * frequency as it was measured.
     */
    public var measurementPeriod: Timing.Builder? = null
