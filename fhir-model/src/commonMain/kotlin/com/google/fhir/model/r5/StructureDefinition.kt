...
public data class StructureDefinition(
  ...
  public companion object {
    ...
    public val EXT_CONTEXT: CompositeSearchParam = CompositeSearchParam("ext-context")

    public val EXT_CONTEXT_EXPRESSION: TokenSearchParam = TokenSearchParam("ext-context-expression")

    public val EXT_CONTEXT_TYPE: TokenSearchParam = TokenSearchParam("ext-context-type")
