...
public data class Observation(
  ...
  public companion object {
    ...
    public val COMPONENT_VALUE_CANONICAL: UriSearchParam =
      UriSearchParam("component-value-canonical")
    ...
    public val COMPONENT_VALUE_REFERENCE: ReferenceSearchParam =
      ReferenceSearchParam("component-value-reference")
    ...
    public val VALUE_CANONICAL: UriSearchParam = UriSearchParam("value-canonical")
    ...
    public val VALUE_MARKDOWN: StringSearchParam = StringSearchParam("value-markdown")

    public val VALUE_QUANTITY: QuantitySearchParam = QuantitySearchParam("value-quantity")

    public val VALUE_REFERENCE: ReferenceSearchParam = ReferenceSearchParam("value-reference")
  }
