...
public data class FormularyItem(
   ...
   */
  public val status: Enumeration<FormularyItemStatusCodes>? = null,
) : DomainResource() {
  ...
  public class Builder() : DomainResource.Builder() {
     ...
     *
     * This status is intended to identify if the formulary item in a local system is in active use
     * within the formulary. For example, a formulary might include a medicinal product and the
     * status relates to its inclusion. At some point in the future, if the status of the formulary
     * item is changed to "inactive" that means that it is no longer valid in the formulary. But the
     * product itself might still be in active use and might be included in other formularies.
     */
    public var status: Enumeration<FormularyItemStatusCodes>? = null

    override fun build(): FormularyItem =
      FormularyItem(
        id = id,
        meta = meta?.build(),
