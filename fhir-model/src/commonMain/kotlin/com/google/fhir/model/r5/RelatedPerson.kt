...
public data class RelatedPerson(
   ...
   *
   * RelatedPerson identifiers might not be unique across instances within a system, as a single
   * human individual may be represented as many different RelatedPerson resources with different
   * roles, periods, or relationships.
   */
   ...
   *
   * The directionality of the relationship is from the RelatedPerson to the Patient. For example,
   * if the Patient is a child, and the RelatedPerson is the mother, the relationship would be PRN
   * (parent) or MTH (mother).
   */
   ...
   *
   * If an individual has a relationship with a patient over multiple, non-adjacent periods, there
   * should be a distinct RelatedPerson instance for each period. For example, if a person is a
   * roommate for a period of time, moves out, and is later a roommate with the same person again,
   * you would have two RelatedPerson instances.
   */
  ...
  public data class Communication(
    ...
    /**
     * Indicates whether or not the related person prefers this language (over other languages he or
     * she masters up a certain level).
     *
    ...
    public class Builder(
      ...
      /**
       * Indicates whether or not the related person prefers this language (over other languages he
       * or she masters up a certain level).
       *
       * This language is specifically identified for communicating healthcare information.
       */
  ...
  public class Builder(
    ...
    /**
     * A language which may be used to communicate with the related person about the patient's
     * health.
     *
     * If no language is specified, this *implies* that the default local language is spoken. If you
     * need to convey proficiency for multiple modes, then you need multiple
