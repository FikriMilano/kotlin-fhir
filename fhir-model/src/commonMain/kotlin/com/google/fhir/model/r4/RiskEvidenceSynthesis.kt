...
public data class RiskEvidenceSynthesis(
  ...
  public val riskEstimate: RiskEstimate? = null,
  /** A description of the certainty of the risk estimate. */
  public val certainty: List<Certainty> = listOf(),
) : DomainResource() {
  override fun toBuilder(): Builder =
    with(this) {
      Builder(status, population.toBuilder(), outcome.toBuilder()).apply {
        id = this@with.id
  ...
  public data class RiskEstimate(
    ...
    public val denominatorCount: Integer? = null,
    ...
    public class Builder() {
      ...
      /** The sample size for the group that was measured for this risk estimate. */
      public var denominatorCount: Integer.Builder? = null

      /** The number of group members with the outcome of interest. */
      public var numeratorCount: Integer.Builder? = null
  ...
  public class Builder(
    ...
    /**
     * An absolute URI that is used to identify this risk evidence synthesis when it is referenced
     * in a specification, model, design or an instance; also called its canonical identifier. This
     * SHOULD be globally unique and SHOULD be a literal address at which at which an authoritative
     * instance of this risk evidence synthesis is (or will be) published. This URL can be the
     * target of a canonical reference. It SHALL remain the same when the risk evidence synthesis is
     ...
     * data type, and can then identify this risk evidence synthesis outside of FHIR, where it is
     * not possible to use the logical URI.
     */
    public var identifier: MutableList<Identifier.Builder> = mutableListOf()

    /**
     * The identifier that is used to identify this version of the risk evidence synthesis when it
     * is referenced in a specification, model, design or instance. This is an arbitrary value
     * managed by the risk evidence synthesis author and is not expected to be globally unique. For
     ...
     * reference to a particular business version of the risk evidence synthesis with the format
     * [url]|[version].
     */
    public var version: String.Builder? = null

    /**
     * A natural language name identifying the risk evidence synthesis. This name should be usable
     ...
     * The date (and optionally time) when the risk evidence synthesis was published. The date must
     * change when the business version changes and it must change if the status code changes. In
     * addition, it should change when the substantive content of the risk evidence synthesis
     * changes.
     *
     * Note that this is not the same as the resource last-modified-date, since the resource may be
     * a secondary representation of the risk evidence synthesis. Additional specific dates may be
     ...
     * maintenance and upkeep of the risk evidence synthesis. This is not necessarily the same
     * individual or organization that developed and initially authored the content. The publisher
     * is the primary point of contact for questions or issues with the risk evidence synthesis.
     ...
     * populated unless the information is available from context (e.g. the language of the risk
     * evidence synthesis is presumed to be the predominant language in the place the risk evidence
     ...
     * A legal or geographic region in which the risk evidence synthesis is intended to be used.
     *
     * It may be possible for the risk evidence synthesis to be used in jurisdictions other than
    ...
    /** The estimated risk of the outcome. */
    public var riskEstimate: RiskEstimate.Builder? = null

    /** A description of the certainty of the risk estimate. */
    public var certainty: MutableList<Certainty.Builder> = mutableListOf()

    override fun build(): RiskEvidenceSynthesis =
