...
public data class List(
  ...
  /**
   * The common subject(s) (or patient(s)) of the resources that are in the list if there is one (or
   * a set of subjects).
   *
   * Some purely arbitrary lists do not have a common subject, so this is optional. Lists having
   * multiple subjects may raise challenges for systems that base access control or other security
   * considerations on linkages to 'subject'. E.g. if a List is associated with multiple Patient
   * subjects, then it would be nominally part of multiple patient compartments, which might drive
   * access rights.
   */
  public val subject: kotlin.collections.List<Reference> = listOf(),
  ...
  public data class Entry(
     ...
     * entry has actually been deleted from the list, the deleted element SHALL be true
     */
     ...
     * SHALL be true. A deleted entry should be displayed in narrative as deleted. This element is
    ...
    public class Builder(
       ...
       * element SHALL be true. A deleted entry should be displayed in narrative as deleted. This
       * element is labeled as a modifier because it indicates that an item is (to be) no longer in
       * the list.
       */
  ...
  public class Builder(
    ...
    /**
     * The common subject(s) (or patient(s)) of the resources that are in the list if there is one
