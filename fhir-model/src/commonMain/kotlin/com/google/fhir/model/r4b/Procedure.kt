...
public data class Procedure(
  ...
  public sealed interface Performed {
    ...
    public data class DateTime(public val `value`: com.google.fhir.model.r4b.DateTime) : Performed

    public data class Period(public val `value`: com.google.fhir.model.r4b.Period) : Performed

    public data class String(public val `value`: com.google.fhir.model.r4b.String) : Performed

    public data class Age(public val `value`: com.google.fhir.model.r4b.Age) : Performed
