...
@Serializable(with = MedicinalProductUndesirableEffectSerializer::class)
...
public data class MedicinalProductUndesirableEffect(
  ...
  public class Builder() : DomainResource.Builder() {
    ...
    /** The symptom, condition or undesirable effect. */
    public var symptomConditionEffect: CodeableConcept.Builder? = null
    ...
    override fun build(): MedicinalProductUndesirableEffect =
