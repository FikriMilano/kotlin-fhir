    ...
    public data class Resource(
      ...
      public data class SearchParam(
        ...
        public class Builder(
           ...
           *
           * This SHOULD be present, and matches refers to a SearchParameter by its canonical URL,
           * except for the control parameters that do not have a canonical URL (or a
           * SearchParameter definition). If systems wish to document their support for modifiers,
           * comparators, target resource types, and chained parameters, they should do using a
           * search parameter resource. This element SHALL be populated if the search parameter
           * refers to a SearchParameter defined by the FHIR core specification or externally
           * defined IGs.
           */
