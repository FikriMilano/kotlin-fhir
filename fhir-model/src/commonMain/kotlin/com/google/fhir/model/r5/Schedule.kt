...
import com.google.fhir.model.r5.serializers.ScheduleSerializer
...
public data class Schedule(
   ...
   *
   * This MAY be used to describe what the schedule is for where it is clearer than just the name of
   * the single actor.
   */
   ...
   *
   * The capacity to support multiple referenced resource types should be used in cases where the
   * specific resources themselves cannot be scheduled without the other, and thus only make sense
  ...
  public class Builder(
     ...
     * The capacity to support multiple referenced resource types should be used in cases where the
     * specific resources themselves cannot be scheduled without the other, and thus only make sense
     * to the system exposing them as a group. Common examples of this are where the combination of
     * a practitioner and a room (Location) are always required by a system.
     */
    public var actor: MutableList<Reference.Builder>
     ...
     * Further description of the schedule as it would be presented to a consumer while searching.
     *
     * This MAY be used to describe what the schedule is for where it is clearer than just the name
     * of the single actor.
     */
     ...
     * planning outside these dates.
     */
    public var planningHorizon: Period.Builder? = null
