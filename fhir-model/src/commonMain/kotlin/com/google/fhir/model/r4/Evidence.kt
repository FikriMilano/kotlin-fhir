 ...
 * compared within the population) and outcome (if specified) that the knowledge (evidence,
...
public data class Evidence(
   ...
   * of this evidence is (or will be) published. This URL can be the target of a canonical
  ...
  /**
   * A formal identifier that is used to identify this evidence when it is represented in other
   ...
   *
   * There may be different evidence instances that have the same identifier but different versions.
   * The version can be appended to the url in a reference to allow a reference to a particular
   * business version of the evidence with the format [url]|[version].
   */
  ...
  /**
   * An explanatory or alternate title for the Evidence giving additional information about its
   * content.
   */
   ...
   * change when the substantive content of the evidence changes.
   *
   * Note that this is not the same as the resource last-modified-date, since the resource may be a
   * secondary representation of the evidence. Additional specific dates may be added as extensions
   ...
   *
   * The effective period for a evidence determines when the content is applicable for usage and is
  ...
  public val exposureBackground: Reference,
  /** A reference to a EvidenceVariable resource that defines the exposure for the research. */
  public val exposureVariant: List<Reference> = listOf(),
  /** A reference to a EvidenceVariable resomece that defines the outcome for the research. */
  public val outcome: List<Reference> = listOf(),
) : DomainResource() {
  override fun toBuilder(): Builder =
    with(this) {
      Builder(status, exposureBackground.toBuilder()).apply {
        id = this@with.id
  ...
  public class Builder(
    ...
    /** A reference to a EvidenceVariable resource that defines the population for the research. */
    public var exposureBackground: Reference.Builder,
     ...
     * instance of this evidence is (or will be) published. This URL can be the target of a
     * canonical reference. It SHALL remain the same when the evidence is stored on different
     * servers.
     *
     ...
     * data type, and can then identify this evidence outside of FHIR, where it is not possible to
     * use the logical URI.
     */
    public var identifier: MutableList<Identifier.Builder> = mutableListOf()

    /**
     * The identifier that is used to identify this version of the evidence when it is referenced in
     * a specification, model, design or instance. This is an arbitrary value managed by the
     * evidence author and is not expected to be globally unique. For example, it might be a
     * timestamp (e.g. yyyymmdd) if a managed version is not available. There is also no expectation
     * that versions can be placed in a lexicographical sequence. To provide a version consistent
     ...
     *
     * There may be different evidence instances that have the same identifier but different
     * versions. The version can be appended to the url in a reference to allow a reference to a
     * particular business version of the evidence with the format [url]|[version].
     */
     ...
     * should change when the substantive content of the evidence changes.
     *
     * Note that this is not the same as the resource last-modified-date, since the resource may be
     * a secondary representation of the evidence. Additional specific dates may be added as
     ...
     * The period during which the evidence content was or is planned to be in active use.
     *
     * The effective period for a evidence determines when the content is applicable for usage and
    ...
    /** A reference to a EvidenceVariable resource that defines the exposure for the research. */
    public var exposureVariant: MutableList<Reference.Builder> = mutableListOf()

    /** A reference to a EvidenceVariable resomece that defines the outcome for the research. */
    public var outcome: MutableList<Reference.Builder> = mutableListOf()
