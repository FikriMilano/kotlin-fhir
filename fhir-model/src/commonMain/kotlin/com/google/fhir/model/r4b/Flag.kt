...
import com.google.fhir.model.r4b.serializers.FlagSerializer
...
public data class Flag(
  ...
  public class Builder(
    ...
    /**
     * The patient, location, group, organization, or practitioner etc. this is about record this
    ...
    /**
     * Allows a flag to be divided into different categories like clinical, administrative etc.
     * Intended to be used as a means of filtering which flags are displayed to particular user or
     * in a given context.
     *
     * The value set will often need to be adjusted based on local business rules and usage context.
     */
    ...
    /**
     * The period of time from the activation of the flag to inactivation of the flag. If the flag
     * is active, the end of the period should be unspecified.
     */
