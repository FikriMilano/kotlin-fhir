...
public data class CarePlan(
  ...
  public companion object {
    public val ACTIVITY_CODE: TokenSearchParam = TokenSearchParam("activity-code")

    public val ACTIVITY_DATE: DateSearchParam = DateSearchParam("activity-date")

    public val ACTIVITY_REFERENCE: ReferenceSearchParam = ReferenceSearchParam("activity-reference")
    ...
    public val GOAL: ReferenceSearchParam = ReferenceSearchParam("goal")
