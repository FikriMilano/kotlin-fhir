...
import com.google.fhir.model.r4.serializers.EnrollmentResponseSerializer
 ...
 * resource.
 */
@Serializable(with = EnrollmentResponseSerializer::class)
...
public data class EnrollmentResponse(
   ...
   */
  public val status: Enumeration<FinancialResourceStatusCodes>? = null,
  /** Original request resource reference. */
  public val request: Reference? = null,
  /** Processing status: error, complete. */
  public val outcome: Enumeration<ClaimProcessingCodes>? = null,
  ...
  public class Builder() : DomainResource.Builder() {
     ...
     * response as not currently valid.
     */
    ...
    /** The practitioner who is responsible for the services rendered to the patient. */
    public var requestProvider: Reference.Builder? = null

    override fun build(): EnrollmentResponse =
      EnrollmentResponse(
        id = id,
        meta = meta?.build(),
