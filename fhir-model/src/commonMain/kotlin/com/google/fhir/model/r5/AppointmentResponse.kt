...
public data class AppointmentResponse(
  ...
  public class Builder(
    ...
    /**
     * Indicates that the response is proposing a different time that was initially requested. The
     * new proposed time will be indicated in the start and end properties.
     */
    public var proposedNewTime: Boolean.Builder? = null
     ...
     * When a recurring appointment is requested, the participant may choose to respond to each
     * individual occurrence, in which case AppointmentResponse.recurring should be false. If the
     * participant chooses to respond the same way for all occurrences, they may instead use a
     * single AppointmentResponse with recurring set to true. These may be combined as the
     * participant chooses. For example, they may accept all occurrences (recurring = true), but
     * then send a decline for a specific occurrence (recurring=false).
     */
    public var recurring: Boolean.Builder? = null
     ...
     * `Appointment.occurrenceDate`).
     */
    public var occurrenceDate: Date.Builder? = null

    /**
     * The recurrence ID (sequence number) of the specific appointment when responding to a
     * recurring request.
     *
     * If the recurrence template was defined using the list of occurrenceDates then this property
     * might not be used.
    ...
    override fun build(): AppointmentResponse =
      AppointmentResponse(
        ...
        proposedNewTime = proposedNewTime?.build(),
        start = start?.build(),
        end = end?.build(),
