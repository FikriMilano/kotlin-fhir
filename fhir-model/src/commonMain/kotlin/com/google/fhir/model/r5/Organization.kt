...
import com.google.fhir.model.r5.serializers.OrganizationQualificationSerializer
import com.google.fhir.model.r5.serializers.OrganizationSerializer
...
public data class Organization(
  ...
  /**
   * Description of the organization, which helps provide additional general context on the
   * organization to ensure that the correct organization is selected.
   */
  public val description: Markdown? = null,
  /**
   * The contact details of communication devices available relevant to the specific Organization.
   ...
   * these are official contacts for the Organization itself for specific purposes. E.g. Mailing
   ...
   *
   * For example, an approval to provide a type of services issued by a certifying body (such as the
  ...
  public class Builder() : DomainResource.Builder() {
    ...
    /**
     * The contact details of communication devices available relevant to the specific Organization.
     * This can include addresses, phone numbers, fax numbers, mobile numbers, email addresses and
     * web sites.
     *
     * The address/telecom use code 'home' are not to be used. Note that these contacts are not the
     * contact details of people who provide the service (that would be through PractitionerRole),
    ...
    /**
     * The official certifications, accreditations, training, designations and licenses that
     * authorize and/or otherwise endorse the provision of care by the organization.
     *
     * For example, an approval to provide a type of services issued by a certifying body (such as
     * the US Joint Commission) to an organization.
     */
