 ...
 */
@Serializable(with = OrganizationAffiliationSerializer::class)
...
public data class OrganizationAffiliation(
   ...
   *
   * For example, a Spotless Cleaning Services (participatingOrganization) is a supplier (code) to
   * General Hospital (organization). Similarly, General Hospital (participatingOrganization) is a
   * member (code) of Eastern HIE (organization). If there are two organizations that do not have a
   * directional relationship, there would normally be a third organization that represents the
  ...
  public class Builder() : DomainResource.Builder() {
     ...
     * For example, a Spotless Cleaning Services (participatingOrganization) is a supplier (code) to
     * General Hospital (organization). Similarly, General Hospital (participatingOrganization) is a
     * member (code) of Eastern HIE (organization). If there are two organizations that do not have
     * a directional relationship, there would normally be a third organization that represents the
     * joint partnership, and the two organizations would have a relationship to that joint
     * Organization via two OrganizationAffiliations.
     */
     ...
     * See comments for OrganizationAffiliation.organization above.
     */
    public var participatingOrganization: Reference.Builder? = null

    /**
     * The network in which the participatingOrganization provides the role's services (if defined)
    ...
    override fun build(): OrganizationAffiliation =
