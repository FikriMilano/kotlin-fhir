...
public data class ResearchSubject(
  ...
  public data class Progress(
    ...
    public class Builder() {
      ...
      /** The current state of the subject. */
      public var subjectState: CodeableConcept.Builder? = null

      /**
       * The milestones the subject has passed through.
       *
       * There can be multiple entries but it is also valid to just have the most recent. This
       * should npt be rlied upon as the full path the subject has taken.
       */
      public var milestone: CodeableConcept.Builder? = null
  ...
  public class Builder(
     ...
     * milestone is a point of time event that results in a change from one state to another. The
     * state before the milestone is achieved is often given the same name as the milestone, and
     * sometimes the state may have the same description. For instance "Randomised" and "Visit 1"
     * may be different milestones but the state remains at "on study" after each of them.
     *
     * It is likely that more than one "state" pattern will be recorded for a subject and a type has
     * been introduced to allow this simultaneous recording.
     */
    public var progress: MutableList<Progress.Builder> = mutableListOf()
     ...
     * Maybe this is really PlanDefinition.
     */
    public var assignedComparisonGroup: Id.Builder? = null

    /** The name of the arm in the study the subject actually followed as part of this study. */
    public var actualComparisonGroup: Id.Builder? = null

    /** A record of the patient's informed agreement to participate in the study. */
    public var consent: MutableList<Reference.Builder> = mutableListOf()
