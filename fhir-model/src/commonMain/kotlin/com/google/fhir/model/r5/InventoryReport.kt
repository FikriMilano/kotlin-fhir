...
public data class InventoryReport(
  ...
  override fun toBuilder(): Builder =
    with(this) {
      Builder(status, countType, reportedDateTime.toBuilder()).apply {
        id = this@with.id
  ...
  public data class InventoryListing(
    ...
    public data class Item(
      ...
      public class Builder(
        ...
        /**
         * The inventory category or classification of the items being reported. This is meant not
         * for defining the product, but for inventory categories e.g. 'pending recount' or
         * 'damaged'.
         */
    ...
    public class Builder() {
      ...
      /** The status of the items. */
      public var itemStatus: CodeableConcept.Builder? = null

      /** The date and time when the items were counted. */
      public var countingDateTime: DateTime.Builder? = null
  ...
  public class Builder(
    ...
    /**
     * Whether the report is about the current inventory count (snapshot) or a differential change
     * in inventory (change).
     */
    public var countType: Enumeration<InventoryCountType>,
    /** When the report has been submitted. */
    public var reportedDateTime: DateTime.Builder,
    ...
    /** The reason for this count - regular count, ad-hoc count, new arrivals, etc. */
    public var operationTypeReason: CodeableConcept.Builder? = null

    /** Who submits the report. */
    public var reporter: Reference.Builder? = null

    /** The period the report refers to. */
    public var reportingPeriod: Period.Builder? = null

    /** An inventory listing section (grouped by any of the attributes). */
    public var inventoryListing: MutableList<InventoryListing.Builder> = mutableListOf()

    /** A note associated with the InventoryReport. */
    public var note: MutableList<Annotation.Builder> = mutableListOf()

    override fun build(): InventoryReport =
      InventoryReport(
        id = id,
        meta = meta?.build(),
        ...
        operationTypeReason = operationTypeReason?.build(),
