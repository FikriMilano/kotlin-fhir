...
import com.google.fhir.model.r4.serializers.CompartmentDefinitionResourceSerializer
import com.google.fhir.model.r4.serializers.CompartmentDefinitionSerializer
...
public data class CompartmentDefinition(
   ...
   * labels.
   */
  override val contained: List<com.google.fhir.model.r4.Resource> = listOf(),
  /**
  ...
  public class Builder(
     ...
     * instance of this compartment definition is (or will be) published. This URL can be the target
     * of a canonical reference. It SHALL remain the same when the compartment definition is stored
     ...
     * labels.
     */
    public var contained: MutableList<com.google.fhir.model.r4.Resource.Builder> = mutableListOf()
     ...
     * The date (and optionally time) when the compartment definition was published. The date must
     * change when the business version changes and it must change if the status code changes. In
     * addition, it should change when the substantive content of the compartment definition
     * changes.
     *
     * Note that this is not the same as the resource last-modified-date, since the resource may be
     * a secondary representation of the compartment definition. Additional specific dates may be
     ...
     * definition as conveyed in the 'text' field of the resource itself. This item SHOULD be
     * populated unless the information is available from context (e.g. the language of the
     * compartment definition is presumed to be the predominant language in the place the
