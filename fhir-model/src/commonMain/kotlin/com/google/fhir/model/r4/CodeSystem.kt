...
public data class CodeSystem(
  ...
  public companion object {
    ...
    public val CONTENT_MODE: TokenSearchParam = TokenSearchParam("content-mode")
    ...
    public val SUPPLEMENTS: ReferenceSearchParam = ReferenceSearchParam("supplements")

    public val SYSTEM: UriSearchParam = UriSearchParam("system")
